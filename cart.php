...
<?php echo "<td align='center' bgcolor='#efebe9 '> <a style='text-decoration:none' href=\"delete_cart.php?id=$row[cart_id]\" onClick=\"return confirm('Are you sure want to delete?')\">Delete</a>
</td>" ?>
